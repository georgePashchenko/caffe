...
model_name = "VGG_MS_COCO_{}".format(job_name)

# Directory which stores the model .prototxt file.
save_dir = "models/VGGNet/MS_COCO/{}".format(job_name)
# Directory which stores the snapshot of models.
snapshot_dir = "models/VGGNet/MS_COCO/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/VGGNet/MS_COCO/{}".format(job_name)
# Directory which stores the detection results.
output_result_dir = "{}/data/MS_COCO/results/{}/Main".format(os.environ['HOME'], job_name)
